...
START /WAIT "Game" "C:UDK\UDK-2013-09\Binaries\Win32\UDK" "C:\UDK\UDK-2013-09\UDKGame\Content\Maps\FSB_Spring_2015\mazeB_phase2_coins.udk?game=mymod.FeelSpaceGame"
